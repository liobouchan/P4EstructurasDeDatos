...
//Funciones
  ...
  //Buscar un bien dentro de la lista
        ...
        if(buscar_en_lista(&Lista,dato.nombre)==1){
          ...
          do{
            ...
            if(val2==2){
              ...
              insertar_bien(&cliente,cliente->id,datosBien);
              system("clear");
              imprimir_bienes(cliente);
            }
            if(val2==3){
              ...
              if(buscar_bien_lista(cliente,llave)==1){
                ...
                do{
                  ...
                  puts("Escriba 3 para la fecha de inicio del producto");
                  puts("Escriba 4 para la fecha de fin del producto");
                  puts("Escriba otra cosa para regresar al menu anterior");
                  setbuf(stdin,NULL);
                  scanf("%d",&val3);
                  if(val3==1){
                    char nvo_nombre[100];
